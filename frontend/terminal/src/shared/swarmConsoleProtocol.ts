...
export type SwarmConsoleCommand =
	...
	| {type: 'command'; command: 'tc_submit_line'; payload: {line: string; client_id?: string}}
	| {type: 'command'; command: 'tc_permission_response'; payload: {request_id: string; allowed: boolean}}
	| {type: 'command'; command: 'tc_question_response'; payload: {request_id: string; answer: string}}
	| {type: 'command'; command: 'tc_set_selected_agent'; payload: {agent_id: string; client_id?: string}};
