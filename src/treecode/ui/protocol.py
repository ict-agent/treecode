...
from treecode.state.app_state import AppState
from treecode.bridge.manager import BridgeSessionRecord
from treecode.mcp.types import McpConnectionStatus
...
class TranscriptItem(BaseModel):
    ...
    :class:`~treecode.engine.query_engine.QueryEngine` messages (the model does not
