...
from treecode.ui.backend_host import run_backend_host
from treecode.ui.react_launcher import launch_react_tui
...
async def run_repl(
    *,
    ...
    """Run the default TreeCode interactive application (React TUI)."""
    if backend_only:
