...
if TYPE_CHECKING:  # pragma: no cover
    from treecode.mcp.client import McpClientManager, McpServerNotConnectedError
    from treecode.mcp.types import (
        McpConnectionStatus,
        McpHttpServerConfig,
        McpJsonConfig,
        McpResourceInfo,
...
def __getattr__(name: str):
    ...
    if name == "McpServerNotConnectedError":
        from treecode.mcp.client import McpServerNotConnectedError
