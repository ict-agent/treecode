"""Build :class:`~treecode.ui.runtime.RuntimeBundle` for in-process teammates."""
...
from treecode.ui.runtime import RuntimeBundle, build_runtime
...
async def build_teammate_runtime_bundle(
    ...
    """Full TreeCode runtime for a running teammate (API, tools, hooks, MCP).
