...
from treecode.swarm.spawn_utils import is_tmux_available
from treecode.swarm.types import BackendDetectionResult, BackendType, TeammateExecutor
...
class BackendRegistry:
    ...
    def get_executor(self, backend: BackendType | None = None) -> TeammateExecutor:
        ...
        Returns:
            The registered :class:`~treecode.swarm.types.TeammateExecutor`.
    ...
    def get_preferred_backend(self, config: dict | None = None) -> BackendType:
        ...
        if config:
            ...
            mode = os.environ.get("TREECODE_TEAMMATE_MODE", "auto")
    ...
    def _register_defaults(self) -> None:
        ...
        from treecode.swarm.in_process import InProcessBackend
