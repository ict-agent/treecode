"""Permission sync protocol for leader-worker coordination in TreeCode swarms.
...
Paths:
    ~/.treecode/teams/<teamName>/permissions/pending/<id>.json
    ~/.treecode/teams/<teamName>/permissions/resolved/<id>.json
"""
...
from treecode.swarm.lockfile import exclusive_file_lock
...
def get_permission_dir(team_name: str) -> Path:
    """Return ~/.treecode/teams/{teamName}/permissions/"""
...
async def get_approver_name(team_name: str | None = None) -> str | None:
    ...
    """
    from treecode.swarm.team_lifecycle import read_team_file_async
...
async def handle_permission_request(
    ...
    Args:
        ...
        checker: An already-configured :class:`~treecode.permissions.checker.PermissionChecker`.
