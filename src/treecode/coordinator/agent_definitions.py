"""Agent definition loading system for TreeCode."""
...
from treecode.config.paths import get_config_dir, get_project_config_dir
...
def get_all_agent_definitions(cwd: str | Path | None = None) -> list[AgentDefinition]:
    ...
    3. User agents (~/.treecode/agents/)
    4. Project-local agents (.treecode/agents/)
    ...
    try:
        from treecode.plugins.loader import load_plugins  # noqa: PLC0415
        from treecode.config.settings import load_settings  # noqa: PLC0415
