...
AGENT_SESSIONS_ROOT = Path(".treecode/sessions")
...
def send_debug_message(session_id: str, message: str) -> None:
    ...
    if not state_file.exists():
        print(f"Error: Session '{session_id}' does not exist. Run 'treecode agent-debug start {session_id}' first")
        return
