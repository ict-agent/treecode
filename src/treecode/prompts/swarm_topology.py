...
from treecode.swarm.context_registry import AgentContextRegistry, get_context_registry
...
Historical files under `~/.treecode/data/swarm/contexts/` are cache snapshots, not the source of truth for the current live tree."""
