...
from treecode.engine.messages import (
    ConversationMessage,
    ContentBlock,
    TextBlock,
    ToolResultBlock,
...
from treecode.services.token_estimation import estimate_tokens
...
async def compact_conversation(
    ...
    *,
    ...
    """
    from treecode.api.client import ApiMessageRequest, ApiMessageCompleteEvent
