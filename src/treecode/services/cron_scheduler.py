...
Runs as a standalone process (``treecode cron start``) or can be embedded via
...
from treecode.config.paths import get_data_dir, get_logs_dir
...
# ---------------------------------------------------------------------------
# Daemon entry point (spawned by ``treecode cron start``)
# ---------------------------------------------------------------------------
