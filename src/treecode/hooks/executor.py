...
from treecode.api.client import ApiMessageCompleteEvent, ApiMessageRequest, SupportsStreamingMessages
...
from treecode.hooks.types import AggregatedHookResult, HookResult
...
class HookExecutor:
    ...
    async def _run_command_hook(
        ...
        process = await asyncio.create_subprocess_exec(
            ...
            env={
                **os.environ,
                "TREECODE_HOOK_EVENT": event.value,
                "TREECODE_HOOK_PAYLOAD": json.dumps(payload),
            },
        )
    ...
    async def _run_prompt_like_hook(
        ...
        *,
        ...
        prefix = (
            "You are validating whether a hook condition passes in TreeCode. "
