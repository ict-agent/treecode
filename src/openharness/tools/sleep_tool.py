...
class SleepTool(BaseTool):
    ...
    name = "sleep"
    description = "Sleep for up to 300 seconds. For waiting on a background task to finish, prefer task_wait which polls and returns as soon as the task completes."
