...
OPENAI_BASE = os.environ.get("TREECODE_OPENAI_COMPAT_BASE", "https://api.moonshot.cn/v1")
...
async def task_memory_research_autoagent():
    ...
    import treecode.memory.scan as ms
...
async def task_full_dev_workflow():
    ...
    from treecode.memory.scan import scan_memory_files
    from treecode.memory.search import find_relevant_memories
    from treecode.services.session_storage import save_session_snapshot, load_session_snapshot
    from treecode.services.cron import upsert_cron_job, load_cron_jobs, validate_cron_expression
    from treecode.engine.messages import ConversationMessage
    import treecode.memory.paths as mp
    import treecode.memory.manager as mm
    import treecode.memory.scan as ms
